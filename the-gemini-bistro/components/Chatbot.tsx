...
const Chatbot: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-5 right-5 z-50 w-[calc(100%-2.5rem)] max-w-sm h-[70vh] max-h-[600px] bg-gray-800 rounded-lg shadow-2xl flex flex-col transition-all duration-300 origin-bottom-right ${
